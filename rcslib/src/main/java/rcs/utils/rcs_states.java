...
public class rcs_states {
    ...
    /**
     * Checks stat.state == stateIn and sets the source_file and source line so
     * that one can check which line of the state table matched.
     *
     * @param stat The status message to be written out via NML.
     * @param stateIn state to check, (NEW_COMMAND, or one of the S? values
     * defined above.)
    ...
    /**
     * Sets the source file and source line. (seems a little redundant
     * especially if you just called state_match())
     *
    ...
    /**
     * Sets the stat.source_line and stat.source_file, called when all
     * state_match()'s fail.
     *
     * @param stat message to update
     */
