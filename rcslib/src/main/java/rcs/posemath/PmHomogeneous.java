...
public class PmHomogeneous {
    ...
    public float[] toMatf() {
        ...
        matf[0] = (float) rot.x.x;
        matf[1] = (float) rot.y.x;
        matf[2] = (float) rot.z.x;
        matf[4] = (float) rot.x.y;
        matf[5] = (float) rot.y.y;
        matf[6] = (float) rot.z.y;
        matf[8] = (float) rot.x.z;
        matf[9] = (float) rot.y.z;
        matf[10] = (float) rot.z.z;
        matf[3] = (float) tran.x;
        matf[7] = (float) tran.y;
    ...
    public float[] toMatfTranspose() {
        float matf[] = new float[16];
        matf[0] = (float) rot.x.x;
        matf[4] = (float) rot.y.x;
        matf[8] = (float) rot.z.x;
        matf[1] = (float) rot.x.y;
        matf[5] = (float) rot.y.y;
        matf[9] = (float) rot.z.y;
        matf[2] = (float) rot.x.z;
        matf[6] = (float) rot.y.z;
        matf[10] = (float) rot.z.z;
