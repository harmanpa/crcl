 ...
 * perhaps considered for use in moast. WARNING: Maintaining this has proven
 * somewhat difficult so it is recommended that you use the original
 * RCS_STAT_MSG or even derive your own status messages from NMLmsg base class
 * unless you are working with a project that has already adopted it.
 *
