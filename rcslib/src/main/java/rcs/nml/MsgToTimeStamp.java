...
/**
 * Interface passed to tell indexer how to get a timestamp double seconds since
 * epoch 12:00 AM Jan 1, 1970
 *
 * @author shackle
 */
public interface MsgToTimeStamp {
    ...
    /**
     * Return the timestamp that should be associated with this message used for
     * indexing log files. Unfortunately different messages use different
