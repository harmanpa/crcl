...
public abstract class NMLmsg implements Cloneable {
    ...
    /**
     * This function should be overloaded to provide a function that will
     * convert this message to a nuetral format that can be used, by many
     * different types of hosts.
     *
     * @param nml_fc NMLFormatConverter that provides functions for updating all
