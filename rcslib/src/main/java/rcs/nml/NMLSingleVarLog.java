...
/**
 * The class is used to store the value a single variable extracted from a large
 * or potentially large message and that was automatically collected at some
 * frequency.
 *
