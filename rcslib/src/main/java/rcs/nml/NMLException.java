...
public class NMLException extends Exception {
    ...
    /**
     * The buffer name of the NMLConnection that was being used, when the
    ...
    /**
     * If an exception was thrown by some function called from within NML such
     * as a socket call, the exception will be caught and wrapped in an
     * NMLException and then thrown.
     */
    public Exception internal_exception = null;

    /**
     * Unique id for this class, Exception implements Serializable interface see
     * documentation for serializable interface for recommendations regarding
     * this variable.
     */
