...
public class RCS_CMD_MSG extends NMLmsg {
    ...
    /**
     * Applications ussually increment the serial number each time a command is
     * sent, this number is ussually echoed back in the status message so that
     * supervisors can tell which command is currently executing or just
     * completed.
     */
