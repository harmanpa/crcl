...
public class RCS_STAT_MSG extends NMLmsg {
    ...
    /**
     * Subordinates ussually set this to the type of the command they are
     * currently executing or just completed. The templates do this
     * automatically.
     */
    public long command_type;

    /**
     * Subordinates ussually set this to the serial_number of the command they
     * are currently executing or just completed. The templates do this
     * automatically.
     */
    ...
    /**
     * Value for status if the module has completed the last command it was
     * given.
     */
    static public final int RCS_DONE = 1;

    /**
     * Value for status if the module is still executing the last command it was
     * given.
     */
    ...
    /**
     * The status of the module is ussually set to either UNINITIALIZED_STATUS,
     * RCS_DONE, RCS_EXEC, or RCS_ERROR, depending on whether the module is
     * currently executing a command or has encountered an error. The templates
     * do this automatically.
     */
    public int status;

    /**
     * Modules that use simple state tables ussually provide the current state
     * here. The templates do this automatically.
     */
    public int state;

    /**
     * Modules that use simple state tables ussually provide the last line
     * matched in the state table here. The line here is meant as the number of
     * if(STATE_MATCH(...) encountered before one was true. The templates do
     * this automatically.
     */
    public int line;
    ...
    /**
     * Modules that use simple state tables ussually provide the last line
     * matched in the state table here. The line here is meant as the line
     * number in the source code of the if(STATE_MATCH( . . .) that was true.
     * The templates do this automatically. The diagnostics tool uses this for
     * the "state table" display.
     */
    public int source_line;

    /**
     * Modules that use simple state tables may provide the name of the source
     * file of the state table that is currently being used here. The templates
     * do this automatically. The diagnostics tool uses this for the "state
     * table" display.
     */
    ...
    /**
     * Derived classes should use this constructor by placing super(_type) in
     * the first line of thier constructors.
     *
    ...
    /**
     * update function for the RCS_STAT_MSG members. Derived classes that have
     * data members that should be communicated should override this function
     * and place super.update(nml_fc) in the first line.
     *
     * @param nml_fc the NMLFormatConverter used to convert basic data types to
     * neutral formats and back.
     */
