...
/**
 * Simple class to track wall-clock performance time. All times are given in
 * seconds but precise to .001 s. (Exact accuracy depends on Operating System,
 * JRE etc ) Absolute times are in seconds since Jan,1 1970 UTC aka "unix time"
 * although see the pages for System.currentTimeMillis()
 *
...
public class time_tracker implements Cloneable {
    ...
    /**
     * Called periodically to measure the wall clock statistics of a periodic
     * function.
     */
    public void cycle() {
        count++;
