...
/**
 * This class is the base class for all classes used by NML to convert local
 * data types to some neutral format usable by many different types of hosts.
 *
...
public abstract class NMLFormatConverterBase extends NMLFormatConverter {
     ...
     * this hosts format, false when a message on this host is being converted
     * to a neutral format.
     */
