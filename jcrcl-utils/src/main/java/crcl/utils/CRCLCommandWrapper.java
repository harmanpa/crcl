...
public class CRCLCommandWrapper extends MessageType {
    ...
    public String toString() {
        return "CrclCommandWrapper{" + "wrappedCommand=" + wrappedCommand + ", curProgram=" + curProgram + ", curProgramIndex=" + curProgramIndex + ", onStartListeners=" + onStartListeners + ", onDoneListeners=" + onDoneListeners + ", onErrorListeners=" + onErrorListeners + '}';
    }
