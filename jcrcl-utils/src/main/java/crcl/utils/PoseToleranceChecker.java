...
public class PoseToleranceChecker {
    ...
    static private boolean containsNull(PointType pt) {
        return pt == null;
//                || pt.getY() == null 
//                || pt.getY() == null
//                || pt.getZ() == null;
    ...
    static private boolean containsNull(VectorType vec) {
        return vec == null;
//                || vec.getI() == null 
//                || vec.getJ() == null
//                || vec.getK() == null;
    ...
    /**
     * Checks whether the given pose is null or has a null value in a required
     * field.
     *
...
//    }
    /**
     * Check whether the absolute value of the difference between two given
     * values is less than or equal to a the tolerance given, if the tolerance
     * is null an infinite difference is still considered in tolerance.
     *
     * @param v1 first value
     * @param v2 second value
     * @param tol tolerance if the tolerance is null an infinite difference is
     * still considered in tolerance.
     * @return whether the absolute value of the difference between two given
     * values is less than or equal to a the tolerance given.
     */
    static private boolean isDoubleInTolerance(double v1, double v2, Double tol) {
    ...
    /**
     * Check whether differences between the two given points in each axis is
     * less than or equal to the tolerance fields for point values.
     *
     * @param pt1 first point
     * @param pt2 second point
     * @param tol tolerance for the difference
     * @return whether differences between the two given points is each axis is
     * less than or equal to the tolerance fields for point values.
     */
    static public boolean isInTolerance(final PointType pt1, final PointType pt2, final PoseToleranceType tol) {
        ...
        return isDoubleInTolerance(pt1.getX(), pt2.getX(), xPointTolerance)
...
//    }
    ...
    /**
     * Check the differences between each field of two poses to see if they are
     ...
     * @return whether all field differences are less than or equal to the
     * limits in tol.
     */
...
//    }
    /**
     * Create an informative string for logging or display describing why two
     * poses are not in tolerance.
     *
     * @param pose1 first pose
     * @param pose2 second pose
     * @param tol tolerance
