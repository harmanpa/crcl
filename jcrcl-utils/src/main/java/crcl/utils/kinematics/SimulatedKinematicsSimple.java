...
public class SimulatedKinematicsSimple {
    ...
    public PoseType jointsToPose(double jv[]) throws CRCLException {
...
//    }
    ...
    public double[] poseToJoints(double[] _jv, PoseType pose) throws CRCLException {
        try {
            double[] jv = _jv;
    ...
    public PoseType jointsToPose(double[] jv, PoseType _pose) throws CRCLException {
        try {
            PoseType pose = null;
            double[] sl = this.scaled_seglengths;
