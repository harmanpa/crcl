...
public class CRCLCopier {
    ...
    public static
    DataThingType copy( DataThingType in) {
    ...
    public static
    CRCLCommandType copy( CRCLCommandType in) {
        assert(in != null): "in==null";
        CRCLCommandType out;
        if(in instanceof SetRotSpeedType) {
            out = copy((SetRotSpeedType)in);
    ...
    public static
    MiddleCommandType copy( MiddleCommandType in) {
        assert(in != null): "in==null";
    ...
    public static
    EnableSensorType copy( EnableSensorType in) {
        assert(in != null): "in==null";
    ...
    public static
    SensorStatusType copy( SensorStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    ScalarSensorStatusType copy( ScalarSensorStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    MoveThroughToType copy( MoveThroughToType in) {
        assert(in != null): "in==null";
    ...
    public static
    ActuateJointType copy( ActuateJointType in) {
        assert(in != null): "in==null";
    ...
    public static
    JointPositionToleranceSettingType copy( JointPositionToleranceSettingType in) {
        assert(in != null): "in==null";
    ...
    public static
    TransSpeedType copy( TransSpeedType in) {
        assert(in != null): "in==null";
        TransSpeedType out;
    ...
    public static
    TransSpeedAbsoluteType copy( TransSpeedAbsoluteType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetEndEffectorType copy( SetEndEffectorType in) {
        assert(in != null): "in==null";
    ...
    public static
    RotAccelType copy( RotAccelType in) {
        assert(in != null): "in==null";
        RotAccelType out;
    ...
    public static
    RotAccelAbsoluteType copy( RotAccelAbsoluteType in) {
        assert(in != null): "in==null";
    ...
    public static
    ConfigureJointReportType copy( ConfigureJointReportType in) {
        assert(in != null): "in==null";
    ...
    public static
    RotSpeedType copy( RotSpeedType in) {
        assert(in != null): "in==null";
        RotSpeedType out;
    ...
    public static
    CommandStatusType copy( CommandStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetRotAccelType copy( SetRotAccelType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetAngleUnitsType copy( SetAngleUnitsType in) {
        assert(in != null): "in==null";
    ...
    public static
    SensorStatusesType copy( SensorStatusesType in) {
        assert(in != null): "in==null";
    ...
    public static
    OnOffSensorStatusType copy( OnOffSensorStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    DisableGripperType copy( DisableGripperType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetTorqueUnitsType copy( SetTorqueUnitsType in) {
        assert(in != null): "in==null";
    ...
    public static
    JointStatusesType copy( JointStatusesType in) {
        assert(in != null): "in==null";
    ...
    public static
    MoveScrewType copy( MoveScrewType in) {
        assert(in != null): "in==null";
    ...
    public static
    GripperStatusType copy( GripperStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    ThreeFingerGripperStatusType copy( ThreeFingerGripperStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    ConfigureStatusReportType copy( ConfigureStatusReportType in) {
        assert(in != null): "in==null";
    ...
    public static
    CRCLProgramType copy( CRCLProgramType in) {
        assert(in != null): "in==null";
    ...
    public static
    PoseAndSetType copy( PoseAndSetType in) {
        assert(in != null): "in==null";
    ...
    public static
    DisableSensorType copy( DisableSensorType in) {
        assert(in != null): "in==null";
    ...
    public static
    ConfigureJointReportsType copy( ConfigureJointReportsType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetTransAccelType copy( SetTransAccelType in) {
        assert(in != null): "in==null";
    ...
    public static
    DisableRobotParameterStatusType copy( DisableRobotParameterStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    CountSensorStatusType copy( CountSensorStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetEndEffectorParametersType copy( SetEndEffectorParametersType in) {
        assert(in != null): "in==null";
    ...
    public static
    StopMotionType copy( StopMotionType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetRobotParametersType copy( SetRobotParametersType in) {
        assert(in != null): "in==null";
    ...
    public static
    CRCLStatusType copy( CRCLStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    RunProgramType copy( RunProgramType in) {
        assert(in != null): "in==null";
    ...
    public static
    JointLimitType copy( JointLimitType in) {
        assert(in != null): "in==null";
    ...
    public static
    GuardsStatusesType copy( GuardsStatusesType in) {
        assert(in != null): "in==null";
    ...
    public static
    CloseToolChangerType copy( CloseToolChangerType in) {
        assert(in != null): "in==null";
    ...
    public static
    EndCanonType copy( EndCanonType in) {
        assert(in != null): "in==null";
    ...
    public static
    SettingsStatusType copy( SettingsStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    VacuumGripperStatusType copy( VacuumGripperStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    RotSpeedAbsoluteType copy( RotSpeedAbsoluteType in) {
        assert(in != null): "in==null";
    ...
    public static
    EnableGripperType copy( EnableGripperType in) {
        assert(in != null): "in==null";
    ...
    public static
    PoseToleranceType copy( PoseToleranceType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetLengthUnitsType copy( SetLengthUnitsType in) {
        assert(in != null): "in==null";
    ...
    public static
    RotSpeedRelativeType copy( RotSpeedRelativeType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetForceUnitsType copy( SetForceUnitsType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetIntermediatePoseToleranceType copy( SetIntermediatePoseToleranceType in) {
        assert(in != null): "in==null";
    ...
    public static
    JointPositionsTolerancesType copy( JointPositionsTolerancesType in) {
        assert(in != null): "in==null";
    ...
    public static
    RotAccelRelativeType copy( RotAccelRelativeType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetMotionCoordinationType copy( SetMotionCoordinationType in) {
        assert(in != null): "in==null";
    ...
    public static
    ForceTorqueSensorStatusType copy( ForceTorqueSensorStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    ParallelGripperStatusType copy( ParallelGripperStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    JointDetailsType copy( JointDetailsType in) {
        assert(in != null): "in==null";
    ...
    public static
    JointSpeedAccelType copy( JointSpeedAccelType in) {
        assert(in != null): "in==null";
    ...
    public static
    JointStatusType copy( JointStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    TransAccelType copy( TransAccelType in) {
        assert(in != null): "in==null";
        TransAccelType out;
    ...
    public static
    TransAccelAbsoluteType copy( TransAccelAbsoluteType in) {
        assert(in != null): "in==null";
    ...
    public static
    GetStatusType copy( GetStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    CRCLCommandInstanceType copy( CRCLCommandInstanceType in) {
        assert(in != null): "in==null";
    ...
    public static
    EnableRobotParameterStatusType copy( EnableRobotParameterStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetTransSpeedType copy( SetTransSpeedType in) {
        assert(in != null): "in==null";
    ...
    public static
    OpenToolChangerType copy( OpenToolChangerType in) {
        assert(in != null): "in==null";
    ...
    public static
    JointForceTorqueType copy( JointForceTorqueType in) {
        assert(in != null): "in==null";
    ...
    public static
    PoseStatusType copy( PoseStatusType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetEndPoseToleranceType copy( SetEndPoseToleranceType in) {
        assert(in != null): "in==null";
    ...
    public static
    ParameterSettingType copy( ParameterSettingType in) {
        assert(in != null): "in==null";
    ...
    public static
    InitCanonType copy( InitCanonType in) {
        assert(in != null): "in==null";
    ...
    public static
    TransSpeedRelativeType copy( TransSpeedRelativeType in) {
        assert(in != null): "in==null";
    ...
    public static
    TransAccelRelativeType copy( TransAccelRelativeType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetDefaultJointPositonsTolerancesType copy( SetDefaultJointPositonsTolerancesType in) {
        assert(in != null): "in==null";
    ...
    public static
    ActuateJointsType copy( ActuateJointsType in) {
        assert(in != null): "in==null";
    ...
    public static
    SetRotSpeedType copy( SetRotSpeedType in) {
        assert(in != null): "in==null";
