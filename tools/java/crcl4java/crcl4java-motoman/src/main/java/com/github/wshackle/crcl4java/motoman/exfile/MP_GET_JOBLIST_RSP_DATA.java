...
public class MP_GET_JOBLIST_RSP_DATA {
    ...
    public final static int MP_LIST_DATA_SIZE=1000;
    ...
    public String toString() {
        return "MP_GET_JOBLIST_RSP_DATA{" + "err_no=" + err_no + ", uIsEndFlag=" + uIsEndFlag + ", uListDataNum=" + uListDataNum + ", cListData=" + cListData + '}';
    }
