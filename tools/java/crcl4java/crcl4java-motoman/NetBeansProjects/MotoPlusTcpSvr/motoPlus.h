...
enum {	FCS_FORCE_SCALE_10E0,				// scale is changed 1 times.
...
#ifndef __INCmpMotCtrlh
#ifndef __INCmpSensCtrlh
typedef struct {
	long	x, y, z;
	long	rx, ry, rz;
	long	ex1, ex2;
	}	MP_COORD;
#endif /* __INCmpSensCtrlh */
#endif /* __INCmpMotCtrlh */
