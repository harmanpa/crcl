 ...
 */
@IID("{75CEF1D6-1E43-11D1-B6FF-00C04FB9C401}")
public interface ICurGroupPosition extends com.github.wshackle.fanuc.robotserver.IPosition {
  // Methods:
  /**
   * <p>
  ...
  @VTID(32)
  com.github.wshackle.fanuc.robotserver.ICurPosition parent();
