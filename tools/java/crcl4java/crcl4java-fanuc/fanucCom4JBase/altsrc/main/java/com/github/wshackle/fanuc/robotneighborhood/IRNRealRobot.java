 ...
 */
@IID("{D7436665-9C06-47E2-8818-AB94F7A2477C}")
public interface IRNRealRobot extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  /**
   * <p>
   * Returns the domain name for the RJ-3 controller that the connection represents.
   * </p>
   * <p>
