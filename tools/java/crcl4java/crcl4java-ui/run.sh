...
export crcl_ui_jar=C:\\Users\\shackle\\Documents\\NetBeansProjects\\GitHubProjects\\usnistgov\\crcl\\tools\\java\\crcl4java\\crcl4java-ui\\target/crcl4java-ui-1.4-SNAPSHOT-jar-with-dependencies.jar
