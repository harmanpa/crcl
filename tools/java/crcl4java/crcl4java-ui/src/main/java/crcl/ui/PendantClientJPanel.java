...
import crcl.utils.PendantClientMenuOuter;
...
//        readRecentPrograms();
    ...
    public boolean validateXmlSelected() {
        checkMenuOuter();
        return menuOuter.validateXmlSelected();
//        return this.jCheckBoxMenuItemValidateXml.isSelected();
    ...
    public boolean replaceStateSelected() {
        checkMenuOuter();
        return menuOuter.replaceStateSelected();
//        return this.jCheckBoxMenuItemReplaceState.isSelected();
    ...
    public boolean isDebugWaitForDoneSelected() {
        checkMenuOuter();;
        return this.menuOuter.isDebugReadStatusSelected();
...
//    }          
    ...
    public boolean isDebugSendCommandSelected() {
        checkMenuOuter();
        return this.menuOuter.isDebugSendCommandSelected();
    }
    ...
    public boolean isEXISelected() {
        checkMenuOuter();
        return this.menuOuter.isEXISelected();
    }

    @Override
    public boolean isUseReadStatusThreadSelected() {
        checkMenuOuter();
        return this.menuOuter.isUseReadStatusThreadSelected();
    }

    @Override
    public boolean isPlotJointsSelected() {
        checkMenuOuter();
        return this.menuOuter.isPlotJointsSelected();
    }

    @Override
    public boolean isPlotXyzSelected() {
        checkMenuOuter();
        return this.menuOuter.isPlotXyzSelected();
    }
...
//        this.jCheckBoxMenuItemQuitProgramOnTestCommandFail.setSelected(internal.isQuitOnTestCommandFailure());
    ...
    public boolean isRecordPoseSelected() {
        checkMenuOuter();
        return this.menuOuter.isRecordPoseSelected();
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (internal.getStatus().getCommandStatus().getCommandState() != CommandStateEnumType.CRCL_DONE) {
                        if (PendantClientJPanel.this.isDebugWaitForDoneSelected()
                                || PendantClientJPanel.this.isDebugSendCommandSelected()) {
...
//            this.internal.savePoseListToCsvFile(tmpFile.getAbsolutePath());
    ...
    public void useExiAction() {
        if (this.isConnected()) {
            this.disconnect();
            this.connect(this.jTextFieldHost.getText(), Integer.parseInt(this.jTextFieldPort.getText()));
        }
    }
...
//        internal.getXpu().setSchemaFiles(internal.getProgramSchemaFiles());
    ...
    public void openXmlInstanceFile(File f) throws CRCLException, SAXException, JAXBException, IOException, ParserConfigurationException, XPathExpressionException {
        ...
        CRCLCommandInstanceType cmdInstance
                = internal.getCRCLSocket().stringToCommand(s, this.validateXmlSelected());
    ...
    private void initComponents() {
        ...
        jCheckBoxMonitorHoldingOutput.setText("Monitor Holding Object");
        ...
        jPanelProgramLayout.setVerticalGroup(
            ...
            .addGroup(jPanelProgramLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPaneProgram, javax.swing.GroupLayout.DEFAULT_SIZE, 218, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel13)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(jPanelStatusLayout.createSequentialGroup()
                .addGroup(jPanelStatusLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelStatusLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanelStatusLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextFieldStatCmdID, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)
                            .addComponent(jTextFieldStatus)
                            .addComponent(jTextFieldStatusID, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                        .addGap(10, 10, 10)))
                .addContainerGap())
        );
        jPanelStatusLayout.setVerticalGroup(
            ...
            .addGroup(jPanelStatusLayout.createSequentialGroup()
                ...
                .addComponent(jLabel18)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane6, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addContainerGap())
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jTabbedPaneLeftUpper, javax.swing.GroupLayout.DEFAULT_SIZE, 975, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
