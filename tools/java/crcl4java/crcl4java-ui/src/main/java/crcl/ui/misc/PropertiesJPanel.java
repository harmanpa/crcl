...
public class PropertiesJPanel extends javax.swing.JPanel {
    ...
    @Nullable public static Properties confirmProperties(Frame _owner, String _title, boolean _modal, Properties props) {
    ...
    @Nullable public static Map<String, String> confirmPropertiesMap(Frame _owner, String _title, boolean _modal, Map<String, String> _map) {
