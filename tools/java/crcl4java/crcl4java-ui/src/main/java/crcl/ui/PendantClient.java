        ...
        for (File f : fa) {
            try {
                ...
                if (!fprog.exists() || !fprog.canRead() || fprog.isDirectory()) {
                    ...
                    if(!was_deleted) {
                        Logger.getLogger(PendantClient.class.getName()).warning(() -> "File "+f+" delete() returned"+was_deleted);
                    }
                    continue;
                }
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.MouseListener, javax.swing.event.ChangeListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == jButtonProgramPause) {
                ...
                PendantClient.this.jMenuItemAboutActionPerformed(evt);
            }
            else if (evt.getSource() == jMenuItemResetPrefs) {
                PendantClient.this.jMenuItemResetPrefsActionPerformed(evt);
            }
        }

        public void mouseClicked(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == jTextAreaErrors) {
                PendantClient.this.jTextAreaErrorsMouseClicked(evt);
            }
        }
        ...
        public void mousePressed(java.awt.event.MouseEvent evt) {
            ...
            else if (evt.getSource() == jTextAreaErrors) {
                PendantClient.this.jTextAreaErrorsMousePressed(evt);
            }
        }
        ...
        public void mouseReleased(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == jLabelJogMinus) {
                ...
                PendantClient.this.jTextAreaErrorsMouseReleased(evt);
            }
        }
...
//        this.setJointControlModes(JointControlModeEnumType.POSITION);
    ...
    private void saveRecentCommandInstance(CRCLCommandInstanceType cmd) throws JAXBException, IOException {
        ...
        Logger.getLogger(PendantClient.class.getName()).finest(() -> "mkdir " + fDir + " returned " + made_dir);
        ...
        Logger.getLogger(PendantClient.class.getName()).finest(() -> "mkdir " + fDir2 + " returned " + made_dir2);
        Date dNow = new Date();
        SimpleDateFormat ft
...
//            this.internal.savePoseListToCsvFile(tmpFile.getAbsolutePath());
    ...
    private void savePrefsFile(File f) {
        try {
            ...
            Logger.getLogger(PendantClient.class.getName()).finest(() -> "mkdir " + crcljavaDir + " returned " + made_dir);
            File settingsRef = new File(crcljavaDir, SETTINGSREF);
