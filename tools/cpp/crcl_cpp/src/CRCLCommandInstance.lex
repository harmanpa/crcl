...
"</"{W}"CRCLCommandInstance"{W}">" {ECH; return CRCLCOMMANDINSTANCEEND;}
"<"{W}"CRCLCommandInstance"   {ECH; return CRCLCOMMANDINSTANCESTART;}
"</"{W}"CRCLCommand"{W}">"    {ECH; return CRCLCOMMANDEND;}
"<"{W}"CRCLCommand"           {ECH; return CRCLCOMMANDSTART;}
...
{W}"xsi:type"{W}"="{W}"\"EndCanonType\""  { ECH; return ENDCANONTYPEDECL; }
{W}"xsi:type"{W}"="{W}"\"GetStatusType\""  { ECH; return GETSTATUSTYPEDECL; }
{W}"xsi:type"{W}"="{W}"\"InitCanonType\""  { ECH; return INITCANONTYPEDECL; }
...
{W}"xsi:type"{W}"="{W}"\"MiddleCommandType\""  { ECH; return MIDDLECOMMANDTYPEDECL; }
